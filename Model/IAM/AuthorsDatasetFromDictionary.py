...
class AuthorsDataset(Dataset):
    ...
    Returns:
        (tensor, tensor, bool):     processed pair of images and label for
                                    training/validation
    """
    def __init__(self, path, root_dir,imagedict ,transform=None, ):
        data_path = path
    ...
    def __getitem__(self, idx):
        ...
        img1 = self.imagedict.get(self.dataframe.iloc[idx,0])
        img2 = self.imagedict.get(self.dataframe.iloc[idx,1])
